...
See [[Save-Slots|Save Slots]] for CLI usage (`--slot`, `--new`, `--list-saves`).
...
Activities: Blackjack, Texas Hold'em, Mandalay Roulette, Craps (min 10 chips). See [[Table-Games|Table Games]] for Hold'em, roulette, and craps.
...
Pick 3, Pick 4, Mega draw, and scratchers. Quick pick or enter your own numbers. See [[Lottery-Counter|Lottery Counter]].

---

## Sports Book floor

Two tabs: **Sports** (moneyline, spread, totals, props, futures, parlays) and **Predictions** (binary contracts). Boards page through stored scenario DBs. See [[Sports-Book-and-Prediction-Markets|Sports Book]].
...
Browse the stored contract catalog, filter by asset class / instrument, buy futures or options, then settle. See [[Trading-Floor|Trading Floor]].

---

## Arcade Alley

Pick a cabinet card to open the **CRT overlay** — Strip Cross, Neon Invaders, High-Roller Breakout, or Showgirl Beat. Earn tickets and redeem small perks. See [[Arcade-Alley|Arcade Alley]].

---

## Racing Pavilion & Equestrian Arena

Thoroughbred win/place/show wagering (min 5 chips) and equestrian dressage / show jumping (min 10 chips). See [[Racing-and-Equestrian|Racing and Equestrian]].
...
5. **Your room** — TV, minibar, phone, decisions, unlockable Vegas vignettes; room phone limo / Rewards Connect Uber unlock [[Strip-Ride|Strip Ride]] (web only)

### Resort dining

From the front desk or **Casino Floor → Resort dining**, open Aureole, Border Grill, or Stripsteak. Order courses with pacing (pace / clean plate / chase shots). Drinks raise encounter odds — strangers, celebrities, satirical escort gags, and staff drop-ins. See [[Resort-Dining|Resort Dining]].

### Strip Ride (web terminal)

From the room phone (**Call limo / private driver**) or Rewards Phone **Connect → Call Uber / Lyft**, dispatch a chip-fare ride to Luxor, Excalibur, Bellagio, or Circa. Away floors restyle menus per property and add five exclusive slots each. See [[Strip-Ride]].
