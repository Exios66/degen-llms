...
def get_resort_completion(session: PlayerSession) -> dict:
    ...
    items = [
        ...
        {"id": "dining_eggs", "label": "Dining encounter eggs", "current": len(dining.unlocked_eggs), "total": TOTAL_DINING_EGGS},
    ]
