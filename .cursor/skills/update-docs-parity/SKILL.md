...
3. **Off-floor:** Hotel, pool complex, MGM Rewards, amenities/bars, VIP venues.
...
10. **History:** Craps, lottery, Hold'em, prediction markets, and Trading Floor are **shipped** (Phases 5–6+). “Ongoing” must not list shipped games.
